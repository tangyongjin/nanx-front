...
var WrapSelect = styled((function (_super) {
    ...
    class_1.prototype.render = function () {
        ...
        var children = dataSource.map(function (item) {
            ...
            return (React.createElement(AntSelect.Option, __assign({ key: value }, others, { label: label, value: value }), label));
        });
        return (React.createElement(AntSelect, __assign({ className: this.props.className }, others), children));
    };
    return class_1;
}(React.Component)))(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  min-width: 100px;\n  width: 100%;\n"], ["\n  min-width: 100px;\n  width: 100%;\n"])));
var Text = styled(function (props) {
    var value;
    ...
    return (React.createElement("div", { className: props.className + " " + (props.size || '') + " text-field" },
        value || 'N/A',
...
export var StateLoading = function (Target) {
    return (function (_super) {
        ...
        Select.prototype.render = function () {
            var _this = this;
            return (React.createElement(Target, __assign({ ref: function (inst) {
                    if (inst) {
                        _this.wrapper = inst;
                    }
                } }, this.props)));
...
export var acceptEnum = function (component) {
    return function (_a) {
...
export var mapStyledProps = function (props, _a) {
    var loading = _a.loading, size = _a.size;
    if (loading) {
        props.state = props.state || 'loading';
        props.suffix = props.suffix || (React.createElement(Icon, { type: "loading", style: { color: 'rgba(0, 0, 0, 0.25)' } }));
    }
    else {
        props.suffix = props.suffix || React.createElement("span", null);
    }
    if (size) {
        props.size = size;
    }
};
export var mapTextComponent = function (Target, props, _a) {
...
export var transformDataSourceKey = function (component, dataSourceKey) {
    return function (_a) {
        var _b;
        var dataSource = _a.dataSource, others = __rest(_a, ["dataSource"]);
        return React.createElement(component, __assign((_b = {}, _b[dataSourceKey] = dataSource, _b), others));
    };
};
export var moveTo = function (element) {
    if (!element || !MoveTo) {
        return;
    }
