...
var Row = (function (_super) {
    ...
    Row.prototype.render = function () {
        ...
        var newClassName = cx(__assign((_c = {}, _c[prefix + "row"] = true, _c[prefix + "row-wrap"] = wrap, _c[prefix + "row-fixed"] = fixed, _c[prefix + "row-fixed-" + fixedWidth] = !!fixedWidth, _c[prefix + "row-justify-" + justify] = !!justify, _c[prefix + "row-align-" + align] = !!align, _c), hiddenClassObj, (_d = {}, _d[className] = !!className, _d)));
        var newChildren = toArr(children);
        ...
        return (React.createElement(Tag, __assign({ role: 'row', className: newClassName }, others), newChildren));
    };
    Row.defaultProps = {
        prefix: 'ant-',
        pure: false,
...
var Col = (function (_super) {
    ...
    Col.prototype.render = function () {
        ...
        var classes = cx(__assign((_c = {}, _c[prefix + "col"] = true, _c[prefix + "col-" + span] = !!span, _c[prefix + "col-fixed-" + fixedSpan] = !!fixedSpan, _c[prefix + "col-offset-" + offset] = !!offset, _c[prefix + "col-offset-fixed-" + fixedOffset] = !!fixedOffset, _c[prefix + "col-" + align] = !!align, _c), pointClassObj, hiddenClassObj, (_d = {}, _d[className] = className, _d)));
        return (React.createElement(Tag, __assign({ role: 'gridcell', className: classes }, others), children));
    };
    Col.isNextCol = true;
    Col.defaultProps = {
        prefix: 'ant-',
