...
var StrengthFC = styled_components_1.default(function (_a) {
    var strength = _a.strength, className = _a.className;
    return (react_1.default.createElement("div", __assign({}, { className: className }), react_1.default.createElement("div", { className: 'password-strength-wrapper' }, react_1.default.createElement("div", { className: 'div-1 div' }), react_1.default.createElement("div", { className: 'div-2 div' }), react_1.default.createElement("div", { className: 'div-3 div' }), react_1.default.createElement("div", { className: 'div-4 div' }), react_1.default.createElement("div", { className: 'password-strength-bar', style: {
...
var PasswordFC = function (props) {
    var _a = react_1.useState(0), strength = _a[0], setStrength = _a[1];
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, react_1.default.createElement(input_1.default.Password, __assign({}, others, { value: props.value || props.defaultValue, onChange: onChangeHandler })), checkStrength && react_1.default.createElement(StrengthFC, __assign({}, { strength: strength }))));
};
react_2.registerFormField('password', react_2.connect({
