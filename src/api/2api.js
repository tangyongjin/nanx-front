...
const getLoggedInUser = () => {
    const user = localStorage.getItem('custname');
    if (user) return user;
    return null;
};
...
// Login Method
const postJwtLogin = (data) => post(url.API_JWT_LOGIN, data);
...
//add invoice details
export const addInvoice = (data) => post(url.ADD_INVOICE, data);
...
const postJwtRegister = (data) => post(url.POST_FAKE_LOGIN, data);

// get invoices
const getInvoices = () => get('/Test/invoices');

const getGames = () => post('/Test/getGames');

export const getGamesSlow = () => post('/Test/getGamesSlow');

// http://127.0.0.1:8502/v2/Custportal/login

const sysLogin = (data) => post('/Custportal/login', data);
